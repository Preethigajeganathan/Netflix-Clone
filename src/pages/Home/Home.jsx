    ...
    <div className='home'>
      ...
      <div className="hero">
        ...
        <div className="hero-caption">
          <img src={hero_title} alt="Tile" className='caption-img' />
          <p>Discovering his ties to a secret ancient orderr, a young man 
            living in modern Istanbul embarks on a quest to save the city 
            from an immortal enemy.
          </p>
          <div className="hero-btns">
            <button className='btn' onClick={() => navigate('/player/home-trailer')}><img src={play_icon} alt="Play" />Play</button>
